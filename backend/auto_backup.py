...
CREATE = {
    ...
    "students": "CREATE TABLE students (id INTEGER NOT NULL PRIMARY KEY, student_id VARCHAR(6) NOT NULL, name VARCHAR NOT NULL, gender VARCHAR NOT NULL, class_id INTEGER NOT NULL, password_hash VARCHAR NOT NULL, FOREIGN KEY(class_id) REFERENCES classes(id))",
